...
// Updated Content array with your specific headings and paragraphs
const content = [
  {
    heading: "Create Locally, Connect Globally",
    text: "Maximize your CPM and enhance engagement by effortlessly localizing content in multiple languages—expanding your global reach while staying cost-effective.",
    image: "https://images.unsplash.com/photo-1472214103451-9374bd1c798e?w=1200&auto=format",
  },
  {
    heading: "No More Retakes — Welcome to the Future of Dubbing",
    text: "Whether you need to win new business or wow an existing client, Webflow empowers agencies to deliver high-quality client work, faster — without growing your dev budget.",
    image: "https://images.unsplash.com/photo-1477959858617-67f85cf4f1df?w=1200&auto=format",
  },
  {
    heading: "Accelerate your agency’s growth",
    text: "Whether you need to win new business or wow an existing client, Webflow empowers agencies to deliver high-quality client work, faster — without growing your dev budget.",
    image: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=1200&auto=format",
  },
];
...
// Text section component
function TextSection({ heading, text, index, setActiveIndex }) {
  const { ref, inView } = useInView({
    threshold: 0.5,
    triggerOnce: false,
  });
  ...
  return (
    ...
    >
      <div className="text-black">
        ...
        <p className="text-lg md:text-xl lg:text-2xl leading-relaxed">{text}</p>
      </div>
    </motion.div>
  );
}
        ...
        <div className="order-2 md:order-1">
          <div className="relative">
            {content.map((item, index) => (
              <TextSection
                key={index}
                heading={item.heading}  // Pass the heading
                text={item.text}        // Pass the paragraph text
                index={index}
                setActiveIndex={setActiveIndex}
              />
            ))}
